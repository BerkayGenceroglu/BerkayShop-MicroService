...
namespace BerkayShop.WebUI.Services.Concrete
{
    public class ClientCredentialTokenService:IClientCredentialTokenService
    {
        ...
        {
            if (_memoryCache.TryGetValue("BerkayShopToken", out string cachedToken))
            {
                return cachedToken;
            }
            ...
            {
                ClientId = _clientSettings.BerkayShopVisitorClient.ClientId,
                ClientSecret = _clientSettings.BerkayShopVisitorClient.ClientSecret,
            ...
            _memoryCache.Set("BerkayShopToken", tokenResponse.AccessToken, TimeSpan.FromSeconds(tokenResponse.ExpiresIn));
