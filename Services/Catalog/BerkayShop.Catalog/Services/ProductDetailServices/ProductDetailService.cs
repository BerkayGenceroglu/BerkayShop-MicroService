...
namespace BerkayShop.Catalog.Services.ProductDetailServices
{
    public class ProductDetailService : IProductDetailService
    {
        ...
        {
            await _productDetailCollection.DeleteOneAsync(y => y.ProductDetailId == id);
        }
        ...
        {
            var value = await _productDetailCollection.Find(y => y.ProductDetailId == id).FirstOrDefaultAsync();
            return _mapper.Map<GetByIdProductDetailDto>(value);
        }

        public async Task<GetByIdProductDetailDto> GetByProductIdProductDetailAsync(string productId)
        {
            var value = await _productDetailCollection.Find(y => y.ProductId == productId).FirstOrDefaultAsync();
            return _mapper.Map<GetByIdProductDetailDto>(value);
        }
