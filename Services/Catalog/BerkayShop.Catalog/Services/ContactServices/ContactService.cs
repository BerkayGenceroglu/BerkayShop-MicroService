...
namespace BerkayShop.Catalog.Services.ContactServices
{
    public class ContactService: IContactService
    {
        ...
        {
            await _contactCollection.DeleteOneAsync(y => y.ContactId == id);
        }
        ...
        {
            var value = await _contactCollection.Find(y => y.ContactId == id).FirstOrDefaultAsync();
